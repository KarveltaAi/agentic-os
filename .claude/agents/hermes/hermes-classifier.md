...
description: Hermes crew (local model). Persona name Hector. Use for tagging, categorising, extracting and restructuring data: labelling feedback, splitting lists, converting formats. Work executes on the LOCAL Hermes 3 model via Ollama - zero Claude usage, data never leaves the machine. Reports to Ben.
...
4. Label the result: "Produced locally by Hermes (Hector)".
